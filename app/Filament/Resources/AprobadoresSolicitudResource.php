...
use App\Filament\Resources\AprobadoresSolicitudResource\Pages;
use App\Filament\Resources\AprobadoresSolicitudResource\RelationManagers;
...
class AprobadoresSolicitudResource extends Resource
{
    protected static ?string $model = aprobadores_solicitud::class;
    protected static ?string $navigationGroup = 'Administracion';
    protected static ?string $navigationLabel = 'Aprobadores Solicitud Compra ';
    ...
    {
        return [
            'index' => Pages\ListAprobadoresSolicituds::route('/'),
            'create' => Pages\CreateAprobadoresSolicitud::route('/create'),
            'edit' => Pages\EditAprobadoresSolicitud::route('/{record}/edit'),
        ];
    }
}
